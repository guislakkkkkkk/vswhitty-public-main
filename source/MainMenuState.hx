	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					#if linux
					Sys.command('/usr/bin/xdg-open', ["https://www.youtube.com/channel/UCVniqkS8csFDi8U2N6UrVhQ", "&"]);
					#else
					FlxG.openURL('https://www.youtube.com/channel/UCVniqkS8csFDi8U2N6UrVhQ');
					#end
				}
				else
				{
